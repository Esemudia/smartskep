                ...
                <div class="custom-row align-items-center">
                    <div class="hero-empowerment-left-content">
                        ...
                        <div class="btns-group d-flex">
                            ...
                            <a href="contact.php" class="theme-btn2">Let's Talk
                    ...
                    <div class="hero-empowerment-right-content">
                        ...
                        <div class="bottom-content d-flex">
                            <a href="team.php" class="our-expert-team-box simple-shadow bounce-in delay-2">
            ...
            <div class="custom-container">
                ...
                <div class="services-list d-flex">
                    <div class="service-card simple-shadow">
                        ...
                        <h3><a href="service-details.php">Development</a></h3>
                    ...
                    <div class="service-card simple-shadow">
                        ...
                        <h3><a href="service-details.php">Woo Commerce</a></h3>
                    ...
                    <div class="service-card simple-shadow">
                        ...
                        <h3><a href="service-details.php">CRM Solutions</a></h3>
                    ...
                    <div class="service-card simple-shadow">
                        ...
                        <h3><a href="service-details.php">Web Design</a></h3>
                    ...
                    <div class="service-card simple-shadow">
                        ...
                        <h3><a href="service-details.php">IT Support</a></h3>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide project-item">
                                        <div class="project-item-inner">
                                            <h2><a href="portfolio-details.php">E-commerce <br>
                                                platform <br>
                                                development.</a></h2>
                                    ...
                                    <div class="swiper-slide project-item">
                                        <div class="project-item-inner">
                                            <h2><a href="portfolio-details.php">Software as a <br>
                                                Service <br>
                                                integration</a></h2>
                                    ...
                                    <div class="swiper-slide project-item">
                                        <div class="project-item-inner">
                                            <h2><a href="portfolio-details.php">Mobile <br>
                                                Platform <br>
                                            Development</a></h2>
                                    ...
                                    <div class="swiper-slide project-item">
                                        <div class="project-item-inner">
                                            <h2><a href="portfolio-details.php">
                                                Enter into a <br>
                                                Virtual Reality <br>
                                                World.</a></h2>
                ...
                <div class="sticky-news d-flex card-h">
                    ...
                    <div class="news-content">
                        ...
                        <h1 class="section-title">
                            <a href="blog-details.php">OpenAI launches new alignment division to tackle risks of superintelligent AI</a>
                        </h1>
                        ...
                        <a href="blog-details.php" class="theme-btn">
                            <i class="iconoir-arrow-up-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="news-items d-flex align-items-start">
                    ...
                    <div class="news-item card-h">
                        ...
                        <div class="news-item-body">
                            ...
                            <h1 class="section-title">
                                <a href="blog-details.php">Bluebase launches Tap to Pay on smartphone for international and domestic business</a>
                            </h1>
                            <p>Small UK merchants, businesses, and other enterprises can now use  Tap to Pay on service to replace payment terminals at point of sale.</p>
                            <ul>
                                <li>
                    ...
                    <div class="news-item card-h">
                        ...
                        <div class="news-item-body">
                            ...
                            <h1 class="section-title">
                                <a href="blog-details.php">Google Bard launches in EU, overcoming data privacy concerns in the region</a>
                            </h1>
                            <p>Small UK merchants, businesses, and other enterprises can now use  Tap to Pay on service to replace payment terminals at point of sale.</p>
                            <ul>
                                <li>
                    ...
                    <div class="custom-row">
                        <div class="footer-all-links-wrap justify-content-between d-flex">
                            <div class="footer-links">
                                <h3>Services</h3>
                                <ul>
                                    <li><a href="service-details.php">IT Support</a></li>
                                    <li><a href="service-details.php">Web Design</a></li>
                                    <li><a href="service-details.php">Development</a></li>
                                    <li><a href="service-details.php">Cloud Things <span class="new">New</span></a></li>
                                    <li><a href="service-details.php">E-Commerce</a></li>
                                    <li><a href="service-details.php">CRM Solutions</a></li>
                                </ul>
                            </div>
                            <div class="footer-links">
                                <h3>Company</h3>
                            ...
                            <div class="footer-links">
                                <h3>Product</h3>
                                <ul>
                                    <li><a href="case-studie.php">Case Studies </a></li>
                            ...
                            <div class="footer-links">
                                <h3>Our Fields</h3>
                                <ul>
                                    <li><a href="our-field-details.php">Healthcare</a></li>
                                    <li><a href="our-field-details.php">Banks</a></li>
                                    <li><a href="our-field-details.php">Logistics</a></li>
                                    <li><a href="our-field-details.php">Supermarkets</a></li>
                                    <li><a href="our-field-details.php">Industries</a></li>
                                    <li><a href="our-field-details.php">Hotels</a></li>
                                </ul>
                            </div>
                            <div class="footer-links">
                                <h3>Legal</h3>
...
<!-- Mirrored from wpriverthemes.com/HTML/synck/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Mar 2024 09:53:14 GMT -->
</html>
